#ifndef OBJ_IO_HPP_INCLUDED
#define OBJ_IO_HPP_INCLUDED
...
void obj_size(string filename, int *node_num, int *face_num, int *normal_num,
              int *order_max);
void obj_size_print(string filename, int node_num, int face_num, int normal_num,
                    int order_max);
...
void obj_write(string output_filename, int node_num, int face_num,
               int normal_num, int order_max, double node_xyz[],
               int face_order[], int face_node[], double normal_vector[],
               int vertex_normal[]);
